...
drug_types = [0, 1, 1, 2, 2]; 
drug_doses = [0, 5, 10, 30, 100]; % uM for Mex, nM for Nif
drug_labels = {'No Drug', 'Mexiletine 5 \muM', 'Mexiletine 10 \muM', ...
               'Nifedipine 30 nM', 'Nifedipine 100 nM'};
